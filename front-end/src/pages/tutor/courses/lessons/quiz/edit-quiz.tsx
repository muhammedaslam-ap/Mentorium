...
import { quizService, type Quiz } from "@/services/quizServices/quizServices"
...
const EditQuizPage: React.FC = () => {
  ...
  const fetchQuizDetails = async () => {
    ...
    try {
      ...
      if (response.success && response.quiz) {
        ...
        setQuestion(response.quiz.question)
        setOptions(response.quiz.options)
        setCorrectAnswer(response.quiz.answer)
      } else {
            ...
            <div className="container mx-auto max-w-3xl">
              <div className="flex justify-center items-center h-[60vh]">
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-violet-700">Loading quiz details...</p>
                </div>
              </div>
            </div>
          </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white to-violet-50">
            ...
            <div className="mb-6">
              ...
              {lesson && (
                <p className="text-violet-600">
                  Editing quiz for lesson: <span className="font-medium">{lesson.title}</span>
                </p>
              )}
            </div>
            ...
            <Card className="border-violet-100 shadow-sm mb-8">
              <CardHeader className="flex flex-row items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Edit your quiz to test students' understanding of the lesson material.
                  </CardDescription>
                </div>
                <Button
                  variant="destructive"
            ...
            <Card className="border-violet-100 shadow-sm">
              ...
              <CardContent>
                <div className="bg-white border border-violet-100 rounded-lg p-6">
                  <h3 className="text-lg font-medium text-violet-900 mb-4">
      ...
      {/* Delete Quiz Dialog */}
      <Dialog open={showDeleteQuizDialog} onOpenChange={setShowDeleteQuizDialog}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle>Delete Quiz</DialogTitle>
            <DialogDescription>
              Are you sure you want to delete this entire quiz? This action cannot be undone and will remove all
              questions and answers.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter className="flex space-x-2 justify-end">
            <Button variant="outline" onClick={() => setShowDeleteQuizDialog(false)}>
              Cancel
            </Button>
