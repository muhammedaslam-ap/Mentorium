...
import { Phone, User, BookOpen, Calendar, Clock, AlertCircle } from "lucide-react"
...
const StudentCallHistory = () => {
  const { userDatas } = useSelector((state: any) => state.user as StudentState)
  ...
  useEffect(() => {
    if (userDatas.role !== "student" || (!userDatas.id && !userDatas._id)) return

    setLoading(true)
    setError(null)
    authAxiosInstance
      .get("/call-history", {
        params: { userId: userDatas.id || userDatas._id, limit: 10, page: 1 },
      })
      .then((response) => {
        ...
        setCalls(
          data.data.map((call: CallHistory) => ({
            ...call,
            tutorName: typeof call.tutorId === "object" ? call.tutorId.name || "Unknown" : "Unknown",
          })),
        )
        setLoading(false)
      })
      .catch((error) => {
        console.error("Failed to fetch student call history:", error)
        setError("Failed to load call history")
        setLoading(false)
      })
  }, [userDatas.id, userDatas._id, userDatas.role])

  if (userDatas.role !== "student") {
    return (
      <>
        <Header />
              ...
              <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
                <Card className="w-full max-w-md">
                  <CardContent className="flex flex-col items-center justify-center py-8">
                    ...
                    <p className="text-gray-600 text-center">Only students can view this page.</p>
                  </CardContent>
                </Card>
              </div>
            </main>
          ...
          <main className="flex-1 overflow-x-hidden overflow-y-auto">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-600">View your recent tutoring sessions and call records</p>
              </div>
                            ...
                            <TableRow>
                              <TableCell colSpan={3} className="h-32">
                                <div className="flex flex-col items-center justify-center text-center">
                                  ...
                                  <p className="text-gray-500">You haven't had any tutoring sessions yet.</p>
                                </div>
                              </TableCell>
                            </TableRow>
                          ) : (
                              ...
                              >
                                <TableCell className="py-4">
                                  <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                      <p className="font-medium text-gray-900">{call.tutorName}</p>
...
export default StudentCallHistory
