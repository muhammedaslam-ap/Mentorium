...
adminWalletSchema.statics.getWallet = function () {
    return __awaiter(this, void 0, void 0, function* () {
        let wallet = yield this.findOne();
        if (!wallet) {
            wallet = yield this.create({ balance: 0, transactions: [] });
        }
        return wallet;
    });
};
exports.AdminWalletModel = mongoose_1.default.model("admin_wallet", adminWalletSchema);
